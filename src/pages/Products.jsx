...
const ProductCard = ({ item }) => {
  return (
    <div className="border rounded-xl shadow-lg p-4 flex flex-col items-center w-full max-w-xs mx-auto bg-white">
...
const Products = ({ item }) => {
  ...
  // ✅ ERROR FIX: use filtered data if passed
  const data = item && item.length > 0 ? item : product;
